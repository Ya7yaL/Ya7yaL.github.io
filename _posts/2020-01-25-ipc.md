...
L'IPC (Indice des prix à la consommation)[^1] soulève beaucoup de questions en classe, en particulier le fameux _panier de biens_ qui permet de le calculer : comment est-il composé ? Comment choisit-on les biens que le constitue ? Questions d'autant plus légitime que l'on explique aux élèves que le taux d'inflation[^2] est centrale dans le pilotage économique de la BCE[^3], et pour la mise en place des politiques macroéconomiques.
